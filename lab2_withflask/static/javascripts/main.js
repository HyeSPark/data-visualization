...
// ** Uncoment below and see the result **
...
// ******************************************************************
  ...
  var yourVlSpec3 = {
    ...
    // ** Implement here **
    // ********************
    // - the graph's width fits in the divider that contains this graph
    encoding: {
      x: {
        timeUnit: "month",
        field: "date",
...
// make the event listener in each html element and bind them with below functions
